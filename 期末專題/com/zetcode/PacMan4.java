...
public class PacMan4 extends JPanel implements ActionListener, KeyListener {
    ...
    private boolean isDualMode = false; // 是否為雙人模式
    ...
    public PacMan4() {
        ...
        int response = JOptionPane.showConfirmDialog(
            null, "是否啟用雙人模式?", "選擇模式", JOptionPane.YES_NO_OPTION);
        isDualMode = (response == JOptionPane.YES_OPTION);
    ...
    private void moveGhostByPlayer2() {
    ...
    public void keyPressed(KeyEvent e) {
        switch (e.getKeyCode()) {
            ...
            case KeyEvent.VK_W:     ghostDx = 0; ghostDy = -1; break; // 玩家2上
            case KeyEvent.VK_S:     ghostDx = 0; ghostDy = 1; break;  // 玩家2下
            case KeyEvent.VK_A:     ghostDx = -1; ghostDy = 0; break; // 玩家2左
            case KeyEvent.VK_D:     ghostDx = 1; ghostDy = 0; break;  // 玩家2右
        }
    }
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Pac-Man: Single or Dual Mode");
